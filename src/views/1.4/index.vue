<template>
  <div>
    <p>
      <a-button type="primary" @click="handleNameChange"> change this.name </a-button>
      <a-button type="primary" @click="handleInfoChange"> change this.info </a-button>
      <a-button type="primary" @click="handleListChange"> change this.list </a-button>
    </p>
